...
} = await import("../js/components/favorites.js?v=1.5.2-location-sync-test");
...
test("la revision JavaScript invalide toute la chaine menant au composant", () => {
    ...
    assert.match(indexSource, /js\/app\.js\?v=1\.5\.2-location-sync/);
    assert.match(appSource, /components\/favorites\.js\?v=1\.5\.2-location-sync/);
    assert.match(appSource, /core\/storage\.js\?v=1\.5\.2-location-sync/);
