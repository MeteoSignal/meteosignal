...
} = await import("../js/components/favorites.js?v=1.4.2-immersive-dashboard-p6f-test");
...
test("la revision JavaScript invalide toute la chaine menant au composant", () => {
    ...
    assert.match(indexSource, /js\/app\.js\?v=1\.4\.2-immersive-dashboard-p6f/);
    assert.match(appSource, /components\/favorites\.js\?v=1\.4\.2-immersive-dashboard-p6f/);
    assert.match(appSource, /core\/storage\.js\?v=1\.4\.2-immersive-dashboard-p6f/);
