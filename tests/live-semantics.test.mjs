...
import { createWeatherDashboardLoader } from "../js/app.js?v=1.5.5-release-test";
...
test("les revisions JavaScript, CSS et PWA restent coherentes", () => {
    ...
    assert.match(APP_SOURCE, /components\/favorites\.js\?v=1\.5\.5-release/);
    assert.match(APP_SOURCE, /components\/hourly-forecast\.js\?v=1\.5\.5-release/);
    ...
    assert.match(INDEX_SOURCE, /css\/[^"']+\?v=1\.5\.5-release/);
