...
test("la documentation distingue la version publique 1.5.1 de l'audit historique 1.4.1", () => {
    ...
    assert.match(read("README.md"), /Version publique : 1\.5\.1/);
    assert.match(read("PROJECT.md"), /publié en version \*\*1\.5\.1\*\*/);
