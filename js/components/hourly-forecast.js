import { formatPercent, formatSpeed, formatTemperature, formatTime } from "../core/formatters.js?v=1.4.2-immersive-dashboard-p6f";
import { createWeatherIconElement } from "../core/weather-icons.js?v=1.4.2-immersive-dashboard-p6f";
