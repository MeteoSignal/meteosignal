import { formatPercent, formatSpeed, formatTemperature, formatTime } from "../core/formatters.js?v=1.3.0-favorites-polish";
import { createWeatherIconElement } from "../core/weather-icons.js?v=1.3.0-favorites-polish";
