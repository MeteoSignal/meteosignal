...
const CACHE_VERSION = "v1.1.3-mobile-forecast-icons";
...
const STATIC_ASSETS = [
    ...
    "./pwa.js",
    "./config/config.js",
    "./config/config.js?v=1.1.3-mobile-forecast-icons",
    "./css/style.css",
    "./css/style.css?v=1.1.3-mobile-forecast-icons",
    "./css/tokens.css",
    "./css/tokens.css?v=1.1.3-mobile-forecast-icons",
    "./css/base.css",
    "./css/base.css?v=1.1.3-mobile-forecast-icons",
    "./css/layout.css",
    "./css/layout.css?v=1.1.3-mobile-forecast-icons",
    "./css/components.css",
    "./css/components.css?v=1.1.3-mobile-forecast-icons",
    "./css/responsive.css",
    "./css/responsive.css?v=1.1.3-mobile-forecast-icons",
    "./js/clock.js",
    "./js/app.js",
    "./js/app.js?v=1.1.3-mobile-forecast-icons",
    ...
    "./js/components/navigation.js?v=1.1.3-mobile-forecast-icons",
    ...
    "./js/core/weather-codes.js?v=1.1.3-mobile-forecast-icons",
